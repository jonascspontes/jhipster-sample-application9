...
export class JhiAlertErrorComponent implements OnDestroy {
  ...
  constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager, translateService: TranslateService) {
    ...
    this.cleanHttpErrorListener = eventManager.subscribe('jhipsterSampleApplication9App.httpError', response => {
      let i;
        ...
        case 400: {
          ...
          if (errorHeader) {
            ...
            for (i = 0; i < fieldErrors.length; i++) {
              ...
              const fieldName = translateService.instant('jhipsterSampleApplication9App.' + fieldError.objectName + '.' + convertedField);
